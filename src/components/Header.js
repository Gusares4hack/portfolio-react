...
import real from '../resources/real.webp';
            ...
            <div className="contendor">
                ...
                {(windowWidth > 1020 || isVisible) && (
                    <div className={`apartados`} style={{ display: 'flex' }}>
                        <div>
                            <a href="#portada" onClick={toggleVisibility}>Start</a>
                        </div>
                        <div>
                            <a href="#proyectos" onClick={toggleVisibility}>Projekte</a>
                        </div>
                        <div>
                            <a href="#sobre_mi" onClick={toggleVisibility}>Über mich</a>
                        </div>
                        <div>
                            <a href="#certificaciones" onClick={toggleVisibility}>Zertifikate</a>
                        </div>
                        <div>
